...
function Hospitais() {
  return (
    <section
      id="hospitais"
      className="section-width flex flex-col lg:flex-row items-center justify-center py-24 gap-8"
    >
      {/* Texto */}
      <div className="w-full lg:w-1/2 text-center lg:text-right mt-0 lg:mt-8 order-2 lg:order-1 ">
